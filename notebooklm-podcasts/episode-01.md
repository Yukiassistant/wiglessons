# Episode 01: Wig Anatomy And Reference Views

Lesson range: 1-9

Episode focus: Identify the physical parts of a wig and learn how front, side, and back references change the build plan.
...
Objective: Know what holds the hair in place.
...
Objective: Understand what the hair is and how full it is.
...
Ready when: You can explain density without touching styling tools.
...
Objective: Separate visible edge needs from the rest of the wig.

Core concept: A visible forehead or pulled-back style needs a planned edge. Lace fronts place individual-looking hairs into sheer lace so the front hairline can show.
...
Objective: Sort hairstyles by structure before styling.
...
Ready when: You can choose a broad build category.
...
Objective: Label the build zones.

Core concept: A wig map labels visible hair, hidden support, hairline, attachments, and problem areas. Each zone gets one job: show, hide, hold, or move.
...
Objective: Identify the main silhouette.
...
Ready when: You can name the main silhouette in one phrase.
...
Objective: Notice depth and gravity.

Core concept: The side view reveals whether hair falls naturally, sticks out, or needs support. This prevents flat front-only planning.
...
Objective: Account for the rear view.
...
Ready when: You can state one back-view requirement.
