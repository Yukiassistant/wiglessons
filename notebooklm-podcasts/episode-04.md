# Episode 04: Cutting Shape, Layers, And Volume

Lesson range: 28-36

Episode focus: Shape face framing, soften edges, compare stand fit to worn fit, and place hidden volume without ruining the surface.
...
## Lesson 28: Face Frame

Objective: Identify front pieces.
...
Ready when: You can identify the face-frame pieces.
...
Objective: Soften blunt edges.

Core concept: Point cutting removes small notches from the end so a cut line looks less blocky. It still needs restraint.
...
Objective: Use layers for shape, not random thinning.
...
Ready when: You can state the purpose before cutting.
...
Objective: Avoid exposing the cap.

Core concept: Thinning removes bulk, but too much near the roots can reveal tracks or cap. Work gradually.
...
Objective: Identify piecey texture.
...
Ready when: You can identify one use for razor texture.
...
Objective: Document cutting choices.

Core concept: Before-and-after photos reveal changes in length, silhouette, symmetry, and density that are hard to judge while the wig is on the stand.
...
Objective: Know when not to keep cutting.

Core concept: Many wig problems get worse when you chase perfection while tired. Define a stop point first.
...
Objective: Use hidden texture for lift.
...
Ready when: You can place crimping in a hidden layer.
