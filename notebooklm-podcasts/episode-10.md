# Episode 10: Transport, Samples, Photos, And Review
...
## Lesson 82: Transport Shape

Objective: Pack for the build type.
...
Ready when: You can choose transport based on shape.
...
Objective: Plan a wearable soft wig.

Core concept: A soft wig project can use a base wig, conservative cut, light shaping, and a clear stop point.
...
Objective: Plan one structural test.
...
Ready when: You have one structural sample idea.
...
Objective: Plan one visible edge test.

Core concept: A hairline or sideburn test is smaller than a full wig and reveals whether the method looks acceptable.
...
Objective: Name the technical reason.

Core concept: Useful critique says why something looks wrong: fit, density, edge, silhouette, color, coverage, or support.
...
Objective: Turn wig work into a repeatable order.

Core concept: A repeatable workflow orders reference, fit, tests, structure, surface styling, wear test, touch-up kit, and storage.
